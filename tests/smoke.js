...
(async () => {
  ...
  const result = await page.evaluate(() => {
    localStorage.clear();
    // This is the base production-chain sanity check, not an enemies test — keep it
    // deterministic regardless of where worldgen happened to scatter creature dens.
    G.peaceful = true;
    const x = 20, y = 20;
